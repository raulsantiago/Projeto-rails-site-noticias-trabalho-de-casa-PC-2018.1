...
class NoticiaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post noticia_url, params: { noticium: { categoria: @noticium.categoria, data_public: @noticium.data_public, image: @noticium.image, texto: @noticium.texto, titulo: @noticium.titulo, usuario_id: @noticium.usuario_id } }
    end
  ...
  test "should update noticium" do
    patch noticium_url(@noticium), params: { noticium: { categoria: @noticium.categoria, data_public: @noticium.data_public, image: @noticium.image, texto: @noticium.texto, titulo: @noticium.titulo, usuario_id: @noticium.usuario_id } }
