...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference('Like.count') do
      post likes_url, params: { like: { noticium_id: @like.noticium_id, usuario_id: @like.usuario_id } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { noticium_id: @like.noticium_id, usuario_id: @like.usuario_id } }
